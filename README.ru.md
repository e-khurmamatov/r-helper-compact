...
Настройки хранятся в `%APPDATA%/r-helper-compact/`. Включены русский и английский языки; язык выбирается по настройкам Windows, остальные языки используют английский. Сборки пока без цифровой подписи.
